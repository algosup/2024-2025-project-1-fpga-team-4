module vga_controller (
    ...
    input wire [9:0] frog_x2,  // Frog's horizontal position
    input wire [9:0] frog_y2,  // Frog's vertical position
    ...
    wire [2:0] frog_r2, frog_g2, frog_b2;
    wire in_frog;
    wire in_frog_test;
    ...
    assign red = (h_counter < H_DISPLAY && v_counter < V_DISPLAY) ? 
                 ((h_counter % GRID_SIZE == 0 || v_counter % GRID_SIZE == 0) ? 3'b111 : (frog_r==3'd000) ? frog_r2 : frog_r) : 3'b000;
    assign green = (h_counter < H_DISPLAY && v_counter < V_DISPLAY) ? 
                   ((h_counter % GRID_SIZE == 0 || v_counter % GRID_SIZE == 0) ? 3'b111 : (frog_g==3'd000) ? frog_g2 : frog_g) : 3'b000;
    assign blue = (h_counter < H_DISPLAY && v_counter < V_DISPLAY) ? 
                  ((h_counter % GRID_SIZE == 0 || v_counter % GRID_SIZE == 0) ? 3'b111 : (frog_b==3'd000) ? frog_b2 : frog_b) : 3'b000;
