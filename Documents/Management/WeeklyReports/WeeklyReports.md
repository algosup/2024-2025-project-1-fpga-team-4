...
14/10 -> 18/10 project hours: 2 halfdays
...
- Bash script are complete
- Levels mechanic is implemented
- Test documents are finished
- User Manual is complete

<h3> Difficulties </h3>

- Few project time
- Three person missing during one of the project time, made accomplishing the week's tasks hard to complete
